      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_400px]">
        <div className="space-y-6">
          ...
          <div className="glass-panel rounded-[2rem] p-6">
            <p className="section-title text-sm text-slate-500">Дансаар шилжүүлэх</p>
            <div className="mt-5 grid gap-3">
              {[
                { label: "Банк", value: bankAccount.bank, key: "bank" },
                { label: "Данс эзэмшигч", value: bankAccount.owner, key: "owner" },
                { label: "Дансны дугаар", value: bankAccount.number, key: "number" },
                { label: "Гүйлгээний утга", value: orderCode, key: "order" },
            ...
            <div className="mt-5 rounded-2xl bg-amber-50 p-4 text-sm leading-7 text-amber-900">
              Төлбөрөө хийсний дараа гүйлгээний screenshot болон захиалгын кодоо {bankAccount.phone} дугаар руу илгээнэ үү.
            </div>
          </div>
        </div>
        ...
        <aside className="h-fit rounded-[2rem] bg-gradient-to-br from-pine via-[#2f5d53] to-[#164e63] p-6 text-white shadow-card">
          ...
          <div className="mt-6 rounded-2xl bg-white/10 p-4 text-sm leading-7 text-white/85">
            ...
            <p className="mt-1">
              {orderCode} кодыг гүйлгээний утга дээр бичиж, нийт {formatPrice(total, "MNT")} шилжүүлнэ.
            </p>
          </div>
